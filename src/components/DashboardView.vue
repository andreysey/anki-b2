...
<template>
  <div class="space-y-8 pt-1 animate-in fade-in duration-500">
    ...
    <div class="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-white/10">
      ...
      <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-primary-500/10 text-primary-600 dark:text-primary-400 border border-primary-500/20 shadow-xs">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
      <div class="p-6 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-sm space-y-3">
        <div class="flex items-center justify-between">
          <span class="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Total Vocabulary</span>
          <div class="w-7 h-7 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-500 dark:text-blue-400">
      ...
      <div class="p-6 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-sm space-y-3">
        <div class="flex items-center justify-between">
          ...
          <div class="w-7 h-7 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-500 dark:text-emerald-400">
      ...
      <div class="p-6 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-sm space-y-3">
        <div class="flex items-center justify-between">
          ...
          <div class="w-7 h-7 rounded-lg bg-primary-500/10 flex items-center justify-center text-primary-500 dark:text-primary-400">
            <i class="pi pi-chart-line text-xs"></i>
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div 
        ...
        :key="lvl.level"
        class="p-6 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-sm space-y-4"
      >
    ...
    <div class="p-6 sm:p-7 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-sm space-y-5">
      <div class="flex items-center justify-between">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div class="p-4 sm:p-5 rounded-xl bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/10 text-center space-y-1">
        ...
        <div class="p-4 sm:p-5 rounded-xl bg-amber-500/10 border border-amber-500/25 text-center space-y-1">
        ...
        <div class="p-4 sm:p-5 rounded-xl bg-blue-500/10 border border-blue-500/25 text-center space-y-1">
        ...
        <div class="p-4 sm:p-5 rounded-xl bg-emerald-500/10 border border-emerald-500/25 text-center space-y-1">
    ...
    <div class="p-6 sm:p-7 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-sm space-y-5">
      ...
      <!-- Sync Controls -->
      <div class="pt-5 border-t border-slate-200 dark:border-white/10 flex items-center justify-between flex-wrap gap-4">
    ...
    <div class="p-6 sm:p-7 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-sm space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
        <div v-for="item in stats" :key="item.thema" class="space-y-2.5 p-4 bg-slate-50 dark:bg-black/40 border border-slate-200/80 dark:border-white/5 rounded-xl hover:border-primary-500/40 transition-all duration-200">
