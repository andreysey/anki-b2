...
<template>
  ...
  >
    ...
    <div class="flex justify-between items-center w-full gap-2 flex-wrap xs:flex-nowrap">
      <div class="flex items-center gap-1.5 sm:gap-2 flex-wrap xs:flex-nowrap">
        ...
        <div class="flex rounded-xl p-1 bg-slate-100 dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700/80 text-xs shadow-2xs">
          <button
            ...
            :class="[
              'px-2 sm:px-2.5 py-1 rounded-lg font-medium transition-all cursor-pointer text-xs',
        ...
        <div class="flex rounded-xl p-1 bg-slate-100 dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700/80 text-xs shadow-2xs">
          <button
            ...
            :class="[
              'px-2 sm:px-2.5 py-1 rounded-lg font-medium transition-all cursor-pointer text-xs flex items-center gap-1',
    ...
    <div
      v-if="isFlipped"
      class="macos-floating-hud p-2 sm:p-2.5 w-full grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5 animate-in fade-in slide-in-from-bottom-2 duration-300 shadow-lg shadow-slate-200/40 dark:shadow-2xl"
    >
      <button
      ...
      >
        ...
        <span class="text-[9.5px] opacity-70 font-mono mt-0.5">
          <span class="hidden sm:inline">Key 1 / </span>Swipe &larr;
        </span>
      </button>
      ...
      >
        ...
        <span class="text-[9.5px] opacity-70 font-mono mt-0.5">
          <span class="hidden sm:inline">Key 3 / </span>Swipe &rarr;
        </span>
      </button>
